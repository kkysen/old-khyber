...
/**
 * more closely implements our in-class SuperIntArray, because it extends MyArrayList<Integer>
 * The one method that isn't the same after autoboxing is toArray(), 
 * because it returns an Integer[] instead of an int[], and due to Java's insufficient autoboxing,
 * generic type erasure, and lack of true value types, it is impossible to write.
 * Therefore, I wrote a toIntArray() method that does return an int[]
 * @see #toIntArray()
 * 
 * @author Khyber Sen
 */
