 ...
 * probabilities out with CRFClassifier. If run without arguments, it shows some
 * of
...
public class NERDemo {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        String serializedClassifier = CLASSIFIER_DIRECTORY
                + "english.all.3class.distsim.crf.ser.gz";
        
        if (args.length > 0) {
            serializedClassifier = args[0];
        }
        final AbstractSequenceClassifier<CoreLabel> classifier = CRFClassifier
        ...
        */
        ...
        if (args.length > 1) {
            ...
            */
            ...
            final String fileContents = IOUtils.slurpFile(args[1]);
            List<List<CoreLabel>> out = classifier.classify(fileContents);
            for (final List<CoreLabel> sentence : out) {
            ...
            System.out.println("---");
            final List<Triple<String, Integer, Integer>> list = classifier
            ...
            final DocumentReaderAndWriter<CoreLabel> readerAndWriter = classifier
                    .makeReaderAndWriter();
            ...
            */
            ...
            final String[] example = {MyFiles.read(Paths.get("Les Miserables.txt"))};
            for (final String str : example) {
            ...
            for (final String str : example) {
                j++;
                final List<Triple<String, Integer, Integer>> triples = classifier
                        .classifyToCharacterOffsets(str);
                for (final Triple<String, Integer, Integer> trip : triples) {
