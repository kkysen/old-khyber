...
public class NERDemo {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    String serializedClassifier = CLASSIFIER_DIRECTORY + "english.all.3class.distsim.crf.ser.gz";
    ...
    */
    ...
    if (args.length > 1) {
      ...
      */
      ...
      final DocumentReaderAndWriter<CoreLabel> readerAndWriter = classifier.makeReaderAndWriter();
      ...
      */
      ...
      for (final String str : example) {
        j++;
        final List<Triple<String,Integer,Integer>> triples = classifier.classifyToCharacterOffsets(str);
